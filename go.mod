module github.com/geniusrabbit/adstdendpoints
...
require (
	...
	github.com/geniusrabbit/notificationcenter/v2 v2.3.4 // indirect
	github.com/geniusrabbit/udetect v0.0.0-20240710122748-8fc28f40dfc7 // indirect
